...
class Page
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=BlockPage::class, mappedBy="page")
    ...
    /**
     * @Vich\UploadableField(mapping="page_fichier", fileNameProperty="fichier")
     * @var File
     */
    private $fichierFile;
    ...
    public function getPartager(): ?bool
    {
        return $this->partager;
    }

    public function setPartager(?bool $partager): self
    {
